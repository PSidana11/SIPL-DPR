...
save_path = r"C:\Users\E01412\Desktop\REPORTS\DAILY\sitamarhi"
sender_name = "SIPL sitamarhi"
target_script = ["sitamarhi.py", "sitamarhi_finance.py"]  # Script to run after download
