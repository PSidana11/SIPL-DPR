...
try:
    ...
    df_finance = df.iloc[29:36, :4]  # Column 0 for names, 2-8 for values
    ...
    cursor.execute("""
        CREATE TABLE IF NOT EXISTS bilaspur_finance (
    ...
    insert_query = "INSERT INTO bilaspur_finance (metric_name, metric_value, entry_date) VALUES (%s, %s, CURDATE())"
    cursor.executemany(insert_query, df_finance[["metric_name", "metric_value"]].values.tolist())
    db_connection.commit()

    print("\n✅ Data successfully inserted into 'bilapsur' table!")
