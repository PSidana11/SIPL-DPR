...
save_path = r"C:\Users\E01412\Desktop\REPORTS\DAILY\yamunavihar"
sender_name = "SIPL yamunavihar"
target_script = ["yamunavihar.py", "yamunavihar_finance.py"]  # Script to run after download
