...
try:
    ...
    df_finance = df.iloc[27:35, :4]  # Column 0 for names, 2-8 for values
    ...
    cursor.execute("""
        CREATE TABLE IF NOT EXISTS sitamarhi_finance (
    ...
    insert_query = "INSERT INTO sitamarhi_finance (metric_name, metric_value, entry_date) VALUES (%s, %s, CURDATE())"
