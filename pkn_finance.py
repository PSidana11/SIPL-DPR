...
try:
    ...
    df_finance = df.iloc[47:54, :7]  # Column 0 for names, 2-8 for values
    ...
    cursor.execute("""
        CREATE TABLE IF NOT EXISTS pkn_finance (
    ...
    insert_query = "INSERT INTO pkn_finance (metric_name, metric_value, entry_date) VALUES (%s, %s, CURDATE())"
